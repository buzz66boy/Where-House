    ...
    return Scaffold(
      ...
      body:  Center(
        child: Column(
          ...
          children: <Widget>[
            SizedBox(height: 20,),
            Text('User List',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold)),
            SizedBox(height: 10,),
            Text("Users"),
            ElevatedButton(onPressed: ()=> _selectAddUser(),child: Text("Add User"))
          ],
        ),
      ),
    );
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (userName.isNotEmpty) {
                  ...
                  List<dynamic> checkedOutItems = jsonDecode(jsonCheckedOutItems);
                  User newUser = User(name: userName, checkedOutItems:checkedOutItems );
                  ...
                  if (success) {
                    Builder(
                      builder: (context) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('User "$userName" add successfully')),
                    ...
                    Builder(
                      builder: (context){
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Failed to add user "$userName"')),
                        );
                        return Container();
                      },
                    );
